...
{
    public class PaytrailClient_CreateCitPaymentAuthorizationHoldTests
    {
        const string MERCHANTIDN = "375917";
        const string MERCHANTIDSIS = "695861";
        const string SECRETKEYSIS = "SAIPPUAKAUPPIAS";

        #region Create Cit Payment Authorization Hold

        [Fact]
        public void CreateCitPaymentAuthorizationHold_RequestNull_ReturnCode400()
        {
            //Arrange
            ...
            CreateMitOrCitPaymentResponse res = payTrail.CreateCitPaymentAuthorizationHold(request, "0e056dd8-408f-11ee-9cb4-e3059a523029");
        ...
        [Fact]
        public void CreateCitPaymentAuthorizationHold_ValidateFalse_ReturnCode403()
        {
            //Arrage
            ...
            CreateMitOrCitPaymentResponse res = payTrail.CreateCitPaymentCharge(request, "0e056dd8-408f-11ee-9cb4-e3059a523029");
            int actual = res.ReturnCode;
        ...
        [Fact]
        public void CreateCitPaymentAuthorizationHold_Success_ReturnCode200()
        {
            //Arrage
            ...
            CreateMitOrCitPaymentResponse res = payTrail.CreateCitPaymentCharge(payload, "0e056dd8-408f-11ee-9cb4-e3059a523029");
            int actual = res.ReturnCode;
        ...
        [Fact]
        public void CreateCitPaymentAuthorizationHold_CallPaytrailReturnFail_ReturnCode500()
        {
            //Arrage
    ...
    #endregion Create Cit Payment Authorization Hold
}
