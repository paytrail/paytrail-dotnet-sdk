...
{
    public class PaytrailClient_CreateCitPaymentCommitTests
    {
        const string MERCHANTIDN = "375917";
        const string MERCHANTIDSIS = "695861";
        const string SECRETKEYSIS = "SAIPPUAKAUPPIAS";

        #region Create Cit Payment Commit

        [Fact]
        public void CreateCitPaymentCommit_RequestNull_ReturnCode400()
        {
            //Arrange
        ...
        [Fact]
        public void CreateCitPaymentCommit_ValidateFalse_ReturnCode403()
        {
            //Arrage
        ...
        [Fact]
        public void CreateCitPaymentCommit_Success_ReturnCode200()
        {
            //Arrage
        ...
        [Fact]
        public void CreateCitPaymentCommit_CallPaytrailReturnFail_ReturnCode500()
        {
            //Arrage
        ...
        #endregion Create Cit Payment Commit
    }
}
